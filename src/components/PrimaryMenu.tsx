    ...
    <div className="g-menu" ref={rootRef}>
      ...
      {open && (
        <div className="g-menu-panel" role="menu">
          <button type="button" role="menuitem" className={`g-menu-item${onHome && (activeTab === "Markets" || activeTab === "Trade") ? " on" : ""}`} onClick={() => goTab("Markets")}>Markets</button>
          ...
          <Link href="/you" role="menuitem" className={`g-menu-item${pathname.startsWith("/you") ? " on" : ""}`} onClick={() => setOpen(false)}>Profile / Rewards</Link>
          ...
          <button type="button" role="menuitem" className={`g-menu-item${onHome && activeTab === "X" ? " on" : ""}`} onClick={() => goTab("X")}>X status</button>
          <div className="g-menu-divider" />
